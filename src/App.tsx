            ...
            <Routes>
              ...
              >
                ...
                <Route
                  path="mesas"
                  element={
                    <PrivateRoute allowedRoles={["admin", "waiter", "cashier"]}>
                      <Mesas />
                    </PrivateRoute>
                  }
                />
                ...
                <Route
                  ...
                  element={
                    <PrivateRoute
                      allowedRoles={["admin", "kitchen", "cashier"]}
                    >
                      <IFoodPedidos />
                    </PrivateRoute>
                  }
                ...
                />
                <Route
                  path="cardapio-online/editor"
                  element={
                    <PrivateRoute allowedRoles={["admin"]}>
                      <CardapioOnlineEditor />
                    </PrivateRoute>
                  }
                />
                <Route
